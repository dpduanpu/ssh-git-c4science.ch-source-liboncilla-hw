...
public :
	...
	BCPP_ADD_OPTION(Stiffness,"stiffness",uint16_t,0,"virtual compliance stiffness")
	BCPP_ADD_OPTION(Damping,"damping",uint16_t,0,"virtual compliance damping")
	BCPP_ADD_OPTION(PreCompression,"precompression",uint16_t,1100,"virtual compliance precompression")


	BCPP_ADD_OPTION(MaxSpeed,"max-speed",uint16_t,32000,"Maximal speed")
	BCPP_ADD_OPTION(MaxAcceleration,"max-acceleration",uint16_t,32000,"Maximal speed")
...
public :
	...
	BCPP_ADD_OPTION(M2Params,"m2-parameters",std::string,"default","Template parameter to use with M2 motor")
